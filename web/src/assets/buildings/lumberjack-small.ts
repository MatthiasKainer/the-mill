...
export default pureLit(name, (el: LitElementWithProps<Props>) => {
    ...
    return html`<div class="${get() === el.team ? "active" : "inactive"}" style="margin: 0; background-image:url('/assets/lumberjack_small_${el.team}.png'); ackground-size: auto; width: 100%; height: 100%;"></div>`
},
{
    styles: [
        sprite,
