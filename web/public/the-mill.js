var e=Object.freeze({__proto__:null,get knight(){return ci},get wagon(){return hi}}),t=Object.freeze({__proto__:null,get mill(){return ji},get castleSmall(){return Ei},get lumberjackSmall(){return Mi},get mineSmall(){return Ri}});
/**
 * @license
...
***************************************************************************** */
function bt(e,t){var o={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(o[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var n=0;for(i=Object.getOwnPropertySymbols(e);n<i.length;n++)t.indexOf(i[n])<0&&Object.prototype.propertyIsEnumerable.call(e,i[n])&&(o[i[n]]=e[i[n]])}return o}const wt=["hay","grain","iron","wood","stone"];function yt(e){var t;return void 0!==e&&void 0!==(null===(t=e)||void 0===t?void 0:t.resources)}function $t(e){var t,o;return void 0!==e&&(null===(t=e)||void 0===t?void 0:t.row)>=0&&(null===(o=e)||void 0===o?void 0:o.col)>=0}function kt(e){var t;return void 0!==e&&void 0!==(null===(t=e)||void 0===t?void 0:t.actions)}function xt(e){var t,o;return e&&(null===(o=null===(t=e)||void 0===t?void 0:t.actions)||void 0===o?void 0:o.max)>0}function Ot(e){var t,o;return e&&(null===(o=null===(t=e)||void 0===t?void 0:t.dices)||void 0===o?void 0:o.length)>0}function jt(e){var t,o;return e&&(null===(o=null===(t=e)||void 0===t?void 0:t.dices)||void 0===o?void 0:o.length)>0}const _t={id:"building-mill",name:"Mill",occurences:{min:1},resources:{grain:{hay:100,generatedResource:50},hay:{generatedResource:50}}};function St(e){return void 0!==e&&e.max>0}const Et=[Object.assign(Object.assign({},_t),{min:0,max:2}),Object.assign(Object.assign({},_t),{min:8,max:10})],At=({min:e,max:t},o,i)=>{const n=e=>o*i*(e/10);return Math.floor(Math.random()*(n(t)-n(e))+n(e))},Tt=(e,t)=>{var o;return null===(o=null==e?void 0:e.map)||void 0===o?void 0:o.reduce(((e,o)=>[...e,...o.reduce(((e,o)=>[...e,...o.elements.filter(yt).filter((e=>e.team===t))]),[])]),[])},Mt=(...e)=>e.reduce(((e,t)=>(e.push(...Object.entries(t.resources).map((e=>{var[o,i]=e,{generatedResource:n}=i,r=bt(i,["generatedResource"]);let s={};s[o]=Object.assign(Object.assign({},r),{generatedResource:n});return Object.assign(Object.assign({},t),{resources:s})}))),e)),[]).filter(Boolean),Ct={gras:{sprite:{name:"gras",file:"hexagonTerrain_sheet",x:414,y:1906},movementCosts:1,defense:0},desert:{sprite:{name:"desert",file:"hexagonTerrain_sheet",x:902,y:627},movementCosts:4,defense:0},mud:{sprite:{name:"mud",file:"hexagonTerrain_sheet",x:658,y:912},movementCosts:4,defense:1},muddyHills:{sprite:{name:"muddyHills",file:"hexagonTerrain_sheet",x:780,y:627},movementCosts:8,defense:3},forest:{sprite:{name:"forest",file:"hexagonTerrain_sheet",x:536,y:912},movementCosts:8,defense:3},mountain:{sprite:{name:"mountain",file:"hexagonTerrain_sheet",x:536,y:1195},movementCosts:10,defense:9}},zt=()=>{var e;const t=Object.keys(Ct);return null!==(e=Ct[t[Math.floor(Math.random()*t.length)]])&&void 0!==e?e:Ct.mountain},Rt=pe("game/world/worldLoaded"),Ht=pe("game/start"),Nt=pe("game/load/sidebar"),Ut=({rows:e,cols:t})=>(e=>{const t=new Array(e.rows*e.cols).map((()=>[]));return Et.forEach((o=>{var i;let n=o.occurences.factor?Math.max(o.occurences.min,t.length/o.occurences.factor):o.occurences.min;for(;n>0;){const s=St(o)?At(o,e.rows,e.cols):(r=t.length,Math.round(Math.random()*(r-1)));t[s]=[...null!==(i=t[s])&&void 0!==i?i:[],Object.assign(Object.assign({},o),{name:o.id,id:dt()})],n--}var r})),t})({rows:e,cols:t}),Bt=(e,{rows:t,cols:o})=>((e,t)=>{const o=new Array(t.rows*t.cols).map((()=>[]));return[ft].forEach((t=>{var i;let n=t.occurences.factor?Math.max(t.occurences.min,o.length/t.occurences.factor):t.occurences.min;for(;n>0;){const r=pt[e](o);o[r]=[...null!==(i=o[r])&&void 0!==i?i:[],Object.assign(Object.assign({},t),{name:t.id,team:e,id:dt()})],n--}})),o})(e,{rows:t,cols:o}),Pt=(e,t,o)=>{var i;return(null!==(i=e.pop())&&void 0!==i?i:[]).map((e=>Object.assign(Object.assign({},e),{row:t,col:o})))};class Dt{constructor(e=4086,t=Uint32Array){this.capacity=e,this.capacity=e,this._keys=[],this._priorities=new t(e+1),this.length=0}clear(){this.length=0}bubbleUp(e){const t=this._keys[e],o=this._priorities[e];for(;e>1;){const t=e>>>1;if(this._priorities[t]<=o)break;this._keys[e]=this._keys[t],this._priorities[e]=this._priorities[t],e=t}this._keys[e]=t,this._priorities[e]=o}bubbleDown(e){const t=this._keys[e],o=this._priorities[e],i=1+(this.length>>>1),n=this.length+1;for(;e<i;){const t=e<<1;if(t>=n)break;let i=this._priorities[t],r=this._keys[t],s=t;const a=t+1;if(a<n){const e=this._priorities[a];e<i&&(i=e,r=this._keys[a],s=a)}if(i>=o)break;this._keys[e]=r,this._priorities[e]=i,e=s}this._keys[e]=t,this._priorities[e]=o}push(e,t=0){if(this.length===this.capacity)throw new Error("Heap has reached capacity, can't push new items");const o=this.length+1;this._keys[o]=e,this._priorities[o]=t,this.bubbleUp(o),this.length++}pop(){const e=this._keys[1];return this.length--,this.length>0&&(this._keys[1]=this._keys[this.length+1],this._priorities[1]=this._priorities[this.length+1],this.bubbleDown(1)),e}peekPriority(){return this._priorities[1]}peek(){return this._keys[1]}toString(){if(0===this.length)return"(empty queue)";const e=Array(this.length-1);for(let t=0;t<this.length;t++)e[t]=this._priorities[t+1];return`[${e.join(" ")}]`}get[Symbol.toStringTag](){return"Heapify"}*[Symbol.iterator](){for(let e=0;e<this.length;e++){const t=this._priorities[e+1],o=this._keys[e+1];yield[o,t]}}*keys(){for(let e=0;e<this.length;e++)yield this._keys[e+1]}*priorities(){for(let e=0;e<this.length;e++)yield this._priorities[e+1]}}const It=e=>e.toPosition().toString();const Lt=(e,t,o,i,n)=>{const r=new Dt;r.push(e,0);const s={},a={},l=[];let c=!1;if(s[It(e)]=It(e),a[It(e)]=0,e.equals(t))return{path:[]};if(i(t))return{path:[]};for(;r.length>0;){const e=r.pop();if(e.equals(t)){c=!0;break}if(r.length>1e3)throw new Error("No what kinda path are you searching for?!");l.push(e.toPosition().toString());for(const c of e.neighbors(o).filter((e=>!s[It(e)])).map((e=>{var t;return null!==(t=o.find((t=>t.equals(e))))&&void 0!==t?t:e}))){if(i(c))continue;l.some((e=>e===It(c)))||l.push(It(c));const o=a[It(e)]+c.cost();n<o||(!a[It(c)]||o<a[It(c)])&&(a[It(c)]=o,r.push(c,o+t.heuristic(c)),s[It(c)]=e.toPosition().toString())}}const d=e.toPosition();if(!c)return{path:[],visited:l};let u=t.toPosition();const h=[];do{h.push(u),u=lt.fromString(s[u.toString()])}while(null!==u&&!u.equals(d));return{path:h.reverse(),visited:l}},Yt=fe("action/abort"),Gt=pe("player/update"),Wt=fe("player/request/select"),Zt=pe("player/buildings/item/selected"),Kt=pe("player/item/moved"),Vt=pe("player/knights/created"),qt=pe("player/wagon/created"),Xt=pe("player/assets/loaded"),Ft=pe("player/action/performed"),Jt=pe("turn/player/actions/hasLeft"),Qt=fe("turn/player/actions/none"),eo=fe("map/hexagon/updated",{readOnce:!0}),to=pe("modes/move/activate"),oo=pe("modes/move/activated"),io=pe("modes/move/deactivate"),no=pe("modes/move/hovered-target"),ro=pe("modes/move/end"),so=pe("modes/build/lumberjack-small"),ao=pe("modes/build/lumberjack-small/success"),lo=pe("modes/build/lumberjack-small/failed"),co=pe("modes/build/mine-small"),uo=pe("modes/build/mine-small/success"),ho=pe("modes/build/mine-small/failed"),vo=pe("modes/battle/activate"),mo=pe("modes/battle/active"),go=pe("modes/battle/end"),fo=pe("modes/battle/deactivate"),po=pe("battle/started"),bo=pe("battle/dice/thrown"),wo=pe("battle/player/attacked"),yo=pe("mill/takeover"),$o=pe("lumberjack/takeover"),ko=pe("mine/takeover"),xo=pe("modal/battle/open"),Oo=pe("modal/dice-result/open"),jo=pe("turn/world/started"),_o=pe("turn/world/accepted"),So=pe("turn/player/complete"),Eo=pe("turn/world/complete"),Ao=pe("resources/generated"),To=pe("resources/generation/complete"),Mo=pe("resources/summary"),Co=pe("resources/distribute"),zo=pe("resources/distribute/request"),Ro=pe("resources/distribute/updated"),Ho=()=>({grain:100,iron:200,hay:0,wood:0,stone:0});function No(e,t){if(!e||!e.map)return[];const o=e=>t===e.team,i=[];for(const t of e.map)for(const e of t)i.push(...e.elements.filter(o));return i}function Uo(e){var t,o,i,n,r;if(!e)return;return[...null!==(r=null===(n=null===(i=null===(o=null===(t=null===document||void 0===document?void 0:document.querySelector("the-mill"))||void 0===t?void 0:t.shadowRoot)||void 0===o?void 0:o.querySelector("world-map"))||void 0===i?void 0:i.shadowRoot)||void 0===n?void 0:n.querySelectorAll("hexagon-element"))&&void 0!==r?r:[]].find((t=>{var o,i;return null===(i=null===(o=t.shadowRoot)||void 0===o?void 0:o.querySelector("sprite-set"))||void 0===i?void 0:i.querySelector(`[id="${e.id}"]`)}))}document.deepQuerySelector=Uo;const Bo=()=>({grain:50,iron:0,hay:0,wood:50,stone:0});function Po(e,t){return e.sprite.name===t}let Do,Io={},Lo=[],Yo=[],Go={};const Wo=e=>Object.assign({},Go[e]),Zo=()=>Go[Do],Ko=e=>e.actions.current>0,Vo=({team:e})=>e===Do;ge.on(Rt,(async e=>{Lo=[],e.map.forEach(((e,t)=>{e.forEach(((e,o)=>{const i=new lt(t,o).toCube();e.terrain.movementCosts&&(i.costs=e.terrain.movementCosts),Lo.push(i)}))})),Io=e,["green","red"].forEach((e=>{Go[e]={resources:{hay:100,grain:200,iron:200,wood:100,stone:100}}})),await we(Ht)})),ge.on(Yt,(async e=>{e&&(we(io),we(fo))})),ge.on([Ht,Nt],(async()=>{await we(jo)})),ge.on(jo,(async()=>{Yo=[...Io.teams],Do=Yo.pop(),await we(_o,Do)})),ge.on(Co,(async({team:e,resourcesToGenerate:t})=>{var o;if(null===(o=Wo(e))||void 0===o?void 0:o.resources){const o=Object.assign({},Wo(e).resources);Go[e].resources=function(e,t){let o=Object.assign({},e),i=[...t],n=!0;for(;n;)n=!1,i=i.map((e=>{let t=e;return Object.entries(e.resources).forEach((i=>{var[r,s]=i,{generatedResource:a}=s,l=bt(s,["generatedResource"]);Object.entries(l).every((([e,t])=>o[e]<=t))&&(n=!0,t=void 0,Object.entries(l).forEach((([e,t])=>{o[e]-=t})),o[r]+=a,we(Ao,e))})),t})).filter(Boolean);return o}(Go[e].resources,t),we(To,{team:e,before:o,after:Go[e].resources})}})),ge.collect(Ao,To,(e=>{var t;we(Mo,null===(t=e[Ao.name])||void 0===t?void 0:t.map((e=>({name:e.name,from:Object.values(e.resources).map((e=>{var t=bt(e,["generatedResource"]);return Object.assign({},t)})),to:Object.keys(e.resources)}))))})),ge.on(_o,(async e=>{const t=No(Io,e);await we(Xt,t);const o=null==t?void 0:t.find((e=>e.name===_i));$t(o)&&we(Wt,{item:_i,row:o.row,col:o.col,payload:o}),setTimeout((()=>{var e;null===(e=Uo(o))||void 0===e||e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}),2),we(Gt,Wo(e));const i=Tt(Io,e).reduce(((e,t)=>[...e,...Mt(t)]),[]);we(Ro,{team:e,resourcesToGenerate:i}),await we(Co,{team:e,resourcesToGenerate:i})})),ge.on(zo,(({team:e})=>{var t;const o=null===(t=Tt(Io,e))||void 0===t?void 0:t.reduce(((e,t)=>[...e,...Mt(t)]),[]);we(Ro,{team:e,resourcesToGenerate:o})})),ge.on(Wt,(async e=>{await we(Zt,Object.assign(Object.assign({},e),{item:"hexagon"})),await we(Zt,Object.assign({},e)),await we(Zt,Object.assign(Object.assign({},e),{item:"hexagon"}))})),ge.on(So,(()=>{Do=Yo.pop(),void 0===Do?we(Eo):we(_o,Do)})),ge.on(Eo,(()=>{Io.map.forEach((e=>{e.forEach((({elements:e})=>{((...e)=>{e.forEach((e=>{e.actions.current=e.actions.max}))})(...e.filter(xt))}))})),we(jo)}));const qo=(e,t)=>{const o=Object.assign({},Go[e].resources);for(const[e,i]of Object.entries(t)){if(o[e]<i)return!1;o[e]-=i}return Go[e].resources=o,!0};ge.on(Vt,(async({row:e,col:t,team:o,origin:i})=>{if(!Vo({team:o}))return;if(!qo(o,{grain:100,iron:200,hay:0,wood:0,stone:0}))return;if(i.actions.current<1)return;const n=(({team:e,row:t,col:o})=>({id:dt(),name:ai,team:e,row:t,col:o,movement:{points:10},actions:{current:2,max:2},health:{current:10,max:10},dices:[Object.assign(Object.assign({},mt(ht.dices.standard)),{sides:[{value:3},{value:3},{value:3},{value:4},{value:5},{value:6}]}),Object.assign(Object.assign({},mt(ht.dices.mightyBlowOfBetrayal)),{sides:[{value:-3},{value:0},{value:0},{value:6},{value:12}]})]}))({row:e,col:t,team:o});Io.map[e][t].elements.push(n),await Promise.all([we(Ft,{item:i}),we(eo,{row:e,col:t,elements:[...Io.map[e][t].elements]}),we(Xt,No(Io,o)),we(Gt,Zo())]),we(Wt,{item:n.name,row:e,col:t,payload:n})})),ge.on(qt,(async({row:e,col:t,team:o})=>{if(!Vo({team:o}))return;if(!qo(o,{grain:50,iron:0,hay:0,wood:50,stone:0}))return;const i=(({team:e,row:t,col:o})=>({id:dt(),name:di,team:e,row:t,col:o,movement:{points:10},actions:{current:2,max:2},health:{current:10,max:10}}))({row:e,col:t,team:o});Io.map[e][t].elements.push(i),await Promise.all([we(eo,{row:e,col:t,elements:[...Io.map[e][t].elements]}),we(Xt,No(Io,o)),we(Gt,Zo())]),we(Wt,{item:i.name,row:e,col:t,payload:i})})),ge.on(Ft,(({item:e})=>{Io.map[e.row][e.col].elements.filter((t=>t.id===e.id)).filter(kt).forEach((e=>e.actions.current--))})),ge.on(Jt,(()=>{void 0===((e,t)=>{for(const o of e.map)for(const e of o){const o=e.elements.filter(xt).map((e=>e)).find((e=>e.team===t&&e.actions.current>0));if(o)return o}})(Io,Do)&&we(Qt,!0)})),ge.on(so,(async({position:e,asset:t})=>{const{elements:o,terrain:i}=Io.map[e.row][e.col],{team:n}=t,r=o.findIndex((e=>"player-wagon"===e.name));if(Vo({team:t.team}))if("player-wagon"!==t.name||r<0)await we(lo,{position:e,asset:t,reason:"No wagon on field"});else if(Po(i,"forest"))if(o.some(yt))await we(lo,{position:e,asset:t,reason:"There is already a building on the field"});else{const i=(({position:e,asset:t})=>Object.assign(Object.assign({id:"lumberjack-small",name:"lumberjack-small",team:t.team},e),{occurences:{min:1},resources:{wood:{generatedResource:50}}}))({position:e,asset:t});o.splice(r,1),o.unshift(i),await Promise.all([we(eo,Object.assign(Object.assign({},e),{elements:[...o]})),we(Xt,No(Io,t.team)),we(Gt,Zo()),we(ao,{position:e,asset:i})]),we(zo,{team:n})}else await we(lo,{position:e,asset:t,reason:`No wood on field but ${i.sprite.name}`});else await we(lo,{position:e,asset:t,reason:`Not the turn of the team ${t.team}`})})),ge.on(co,(async({position:e,asset:t})=>{const{elements:o,terrain:i}=Io.map[e.row][e.col],{team:n}=t,r=o.findIndex((e=>"player-wagon"===e.name));if(Vo({team:t.team}))if("player-wagon"!==t.name||r<0)await we(ho,{position:e,asset:t,reason:"No wagon on field"});else if(Po(i,"mountain"))if(o.some(yt))await we(ho,{position:e,asset:t,reason:"There is already a building on the field"});else{const i=(({position:e,asset:t})=>Object.assign(Object.assign({id:"mine-small",name:"mine-small",team:t.team},e),{occurences:{min:1},resources:{stone:{generatedResource:50},iron:{generatedResource:50}}}))({position:e,asset:t});o.splice(r,1),o.unshift(i),await Promise.all([we(eo,Object.assign(Object.assign({},e),{elements:[...o]})),we(Xt,No(Io,t.team)),we(Gt,Zo()),we(uo,{position:e,asset:i})]),we(zo,{team:n})}else await we(ho,{position:e,asset:t,reason:`No mountain on field but ${i.sprite.name}`});else await we(ho,{position:e,asset:t,reason:`Not the turn of the team ${t.team}`})}));const Xo=e=>Number.parseInt(e.toString(),10),Fo=e=>{const{row:t,col:o}=e.toCoords();return Io.map[t][o].elements.filter((e=>e.team!==(null==Jo?void 0:Jo.asset.name))).some(jt)};let Jo,Qo;ge.on(to,(async e=>{function t(t){return function(e,t,o,i,n){return Lt(e,t,o,i,n).path.length>0}(new lt(Xo(e.start.row),Xo(e.start.col)).toCube(),new lt(Xo(t.position.row),Xo(t.position.col)).toCube(),Lo,Fo,e.asset.movement.points)}Qo&&await we(fo),Vo(e.asset)&&(Jo=Object.assign(Object.assign({},e),{inReach:Io.map.reduce(((e,o)=>[...e,...o.filter(t).map((e=>e.position))]),[])}),await we(oo,e))})),ge.on(io,(()=>{Jo=void 0})),ge.on(no,(async e=>{var t,o;if(!Jo)return;const i=new lt(Xo(Jo.start.row),Xo(Jo.start.col)).toCube(),n=new lt(Xo(e.row),Xo(e.col)).toCube(),r=Lt(i,n,Lo,Fo,Jo.asset.movement.points).path;let s=e;Fo(n)&&(s=null!==(o=null===(t=[...r].pop())||void 0===t?void 0:t.toCoords())&&void 0!==o?o:Jo.start),await we(to,Object.assign(Object.assign({},Jo),{trail:r,end:s}))})),ge.on(ro,(async e=>{var t,o;if(!Jo)return;if((null!==(o=null===(t=Jo.trail)||void 0===t?void 0:t.length)&&void 0!==o?o:0)<1)return;const{start:i,asset:n}=Jo;if(!Vo(n))return;if(void 0===n.actions&&console.error("asset.actions undefined",n),!Ko(n))return;if(at(Jo.start,e))return void we(io);n.actions.current-=1;const r=[...Io.map[i.row][i.col].elements];Io.map[i.row][i.col].elements=[],r.forEach((t=>{t.id!==n.id?Io.map[i.row][i.col].elements.push(Object.assign(Object.assign({},t),{row:i.row,col:i.col})):Io.map[e.row][e.col].elements.push(Object.assign(Object.assign({},t),{row:e.row,col:e.col}))})),await we(eo,{row:i.row,col:i.col,elements:[...Io.map[i.row][i.col].elements]}),await we(eo,{row:e.row,col:e.col,elements:[...Io.map[e.row][e.col].elements]}),await we(io),await we(Kt,{asset:n,location:e}),await we(Jt)})),ge.on(vo,(async e=>{Vo(e.asset)&&(Jo&&await we(io),Qo=Object.assign(Object.assign({},e),{range:new lt(e.start.row,e.start.col).toCube().range(1).map((e=>e.toPosition().toCoords()))}),we(mo,Qo))})),ge.on(go,(async e=>{if(!Qo||!Vo(Qo.asset))return;if(at(Qo.start,e))return void we(fo);const{row:t,col:o}=e,{asset:i}=Qo,n=[...Io.map[t][o].elements].filter((e=>Ot(e)&&e.team!==i.team));Ko(i)&&n.length>0&&(i.actions.current-=1,await we(po,{location:e,attacker:[i],defender:[...n]})),we(Xt,No(Io,i.team)),we(fo),await we(Jt)})),ge.on(fo,(()=>Qo=void 0)),ge.on(Kt,(async({asset:e,location:t})=>{if(!Vo(e))return;const{row:o,col:i}=t,n=[...Io.map[o][i].elements].filter((t=>t.id!==e.id));for(const{building:o,hormone:i}of[{building:xi,hormone:yo},{building:Ai,hormone:$o},{building:Ci,hormone:ko}]){const r=n.filter((t=>t.name===o&&t.team!==e.team));if(r.length>0&&Ot(e)){const o={asset:r[0],transfered:{from:r[0].team,to:e.team},location:t,by:e,team:e.team};await we(i,o)}}we(Xt,No(Io,e.team)),await we(Jt)})),[yo,$o,ko].forEach((e=>{ge.on(e,(({location:e,team:t,asset:o})=>{if(!Vo({team:t}))return;const{row:i,col:n}=e,r=[...Io.map[i][n].elements];Io.map[i][n].elements=[],r.forEach((e=>{e.id!==o.id?Io.map[i][n].elements.push(e):Io.map[i][n].elements.push(Object.assign(Object.assign({},e),{team:t}))})),we(Xt,No(Io,t)),we(zo,{team:t})}))})),ge.on(po,(e=>{we(xo,e)})),ge.on(bo,(e=>{if(!Vo(e.attacker.asset))return;const t=gt(e.attacker.dices);we(wo,{attacker:e.attacker.asset,defender:e.defender,damage:t,location:e.location})})),ge.on(wo,(e=>{const{defender:t,damage:o,attacker:i}=e,n=Object.assign(Object.assign({},i),{health:Object.assign(Object.assign({},i.health),{current:o<0?i.health.current+o:i.health.current})}),r=Object.assign(Object.assign({},t),{health:Object.assign(Object.assign({},t.health),{current:o>0?t.health.current-o:t.health.current})}),{row:s,col:a}=e.location,l=[...Io.map[s][a].elements];Io.map[s][a].elements=[],l.forEach((e=>{e.id===r.id?r.health.current>0&&Io.map[s][a].elements.push(r):e.id===n.id?n.health.current>0&&Io.map[s][a].elements.push(n):Io.map[s][a].elements.push(e)})),we(eo,{row:s,col:a,elements:[...Io.map[s][a].elements]}),we(xo,void 0),we(Oo,{attacker:[i],defender:[t],defender_after:[r],attacker_after:[n],location:e.location,result:o})})),window.location.hash.indexOf("log")>=0&&le(se.INFO),window.location.hash.indexOf("trace")>=0&&le(se.TRACE);const ei=ne`
    :host {
        position: absolute;
        width: 120px;
        height: 140px;
...
`;Se("button-image",(e=>{const t=e.height?`height:${e.height};`:"";return R`<button style="${t}; background-image: url('${e.src}'), url('/assets/sidebar/btn_1.png')">
        <slot></slot>
    </button>`}),{styles:a`
    button {
        background: none;
    ...
    `,defaults:{src:"",height:""}}),Se("button-pure",(()=>R`<button>
        <slot></slot>
    </button>`),{styles:a`
...
`,si=(e,t)=>{e.dispatchEvent(new CustomEvent(t))};Se("modal-window",(e=>e.open?R`
    ...
    `:R``),{styles:[ni,ri],defaults:{open:!1,preventClose:!1}}),Se("modal-container",(e=>{const{getState:t,publish:o}=ot(e,!1);return R`
    ...
    `}));Se("text-block",(({size:e,type:t})=>R`<span class="${e} ${t}"><slot></slot></span>`),{styles:[a`
    .small {
        font-size: 0.75rem;
    }
    .medium {
...
`],defaults:{size:"medium",type:"inline"}});Se("loading-bar",(({width:e})=>R`
...
`],defaults:{width:"100%"}});Se("dice-roll",(({result:e})=>R`<div id="cube">
        <div id="side1"></div>
        <div id="side2"></div>
        <div id="side3">${e}</div>
        <div id="side4"></div>
...
`,props:[{result:{type:Number}}]});const ai="player-knight";var li=Se(ai,(e=>{const{get:t,set:o}=ot(e,"");return $e(e,_o,o),R`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/knight_${e.team}.png'"></div>`}),{styles:[ei,ti,a`
        div {
            background-size: contain;
            opacity: 1;
        }
        `],defaults:{team:""}}),ci=Object.freeze({__proto__:null,name:ai,default:li});const di="player-wagon";var ui=Se(di,(e=>{const{getState:t,publish:o}=ot(e,"");return $e(e,_o,o),R`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/wagon_${e.team}.png'"></div>`}),{styles:[ei,ti,a`
        div {
            background-size: contain;
            opacity: 1;
        }
        `],defaults:{team:""}}),hi=Object.freeze({__proto__:null,name:di,default:ui});Se("dice-selector",(e=>{var t;return R`${null===(t=e.dices)||void 0===t?void 0:t.map((t=>R`<div>
        <input type="radio" 
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class mi extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){if(super(e),this.it=N,e.type!==vi)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===N||null==e)return this.ft=void 0,this.it=e;if(e===H)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}mi.directiveName="unsafeHTML",mi.resultType=1;const gi=(e=>(...t)=>({_$litDirective$:e,values:t}))(mi);async function fi(e){for(const t of e)await t()}const pi=(e,t)=>{var o,i;return[...null!==(o=t.none)&&void 0!==o?o:[],...null!==(i=t[e])&&void 0!==i?i:[]]};Se("sprite-set",(e=>{const{getState:t,publish:o}=ot(e,void 0),{getState:i,publish:n}=ot(e,void 0);return $e(e,eo,(t=>e.row.toString()===(null==t?void 0:t.row.toString())&&e.col.toString()===(null==t?void 0:t.col.toString())),o),$e(e,_o,n),t()&&fi(pi(i(),e.triggers)).then((()=>we(Zt,{item:"hexagon",row:e.row,col:e.col}))),tt(e,(()=>{e.addEventListener("click",(async()=>{fi(pi(i(),e.triggers))}))})),R`<slot></slot>`}),{defaults:{row:0,col:0,triggers:{}}}),Se("sprite-player-elements-grid",(()=>R`<slot></slot>`),{styles:a`
    slot {
        display: grid;
        align-items: center;
        grid-template-columns: repeat(6, 1fr);
    }
    `});const bi=(o,i,n)=>{const r={},s=null==o?void 0:o.map((o=>{var s,a,l,c;const d=Object.entries(Object.assign(Object.assign({},t),e)).find((([e,t])=>t.name===o.name)),u=Object.entries(Object.assign(Object.assign({},o),{name:void 0})).filter((([e,t])=>void 0!==t)).map((([e,t])=>`${e}="${t}"`)).join(" "),h=null!==(s=o.team)&&void 0!==s?s:"none";return r[h]=null!==(a=r[h])&&void 0!==a?a:[],r[h].push((()=>{var e;return we(Zt,{item:null!==(e=null==d?void 0:d[1].name)&&void 0!==e?e:"",row:i,col:n,payload:Object.assign({},o)})})),R`${gi(`<${null!==(l=null==d?void 0:d[1].name)&&void 0!==l?l:"span"} ${u}></${null!==(c=null==d?void 0:d[1].name)&&void 0!==c?c:"span"}>`)}`}));return R`<sprite-set .triggers=${r} col="${n}" row="${i}">${s}</sprite-set>`};Se("fighter-info",(({player:e,row:t,col:o})=>R`<div class="sprite ${(null==e?void 0:e.health.current)<1?"dead":"alive"}">
            ${bi(e?[e]:[],t,o)}
        </div>
        <div class="info">
            <h3>Gesundheit</h3>
...
`,$i=(e,t,o)=>`${function(e,t){var o,i,n;return t?at(t.start,e)?"active start":t.end&&(null!==(i=null===(o=t.trail)||void 0===o?void 0:o.length)&&void 0!==i?i:0)<1&&at(t.end,e)?"active unreachable":t.end&&at(t.end,e)?"active end":t.trail&&t.trail.some((t=>at(t,e)))?"active trail":(null===(n=t.inReach)||void 0===n?void 0:n.some((t=>at(t,e))))?"inactive":"inactive unreachable":""}(e,t)} ${function(e,t){return t?at(t.start,e)?"active start":t.end&&at(t.end,e)?"active end":t.range&&t.range.some((t=>at(t,e)))?"active trail":"inactive":""}(e,o)}`,ki=(e,t,o)=>{t&&t.end&&at(t.end,e)?function(e,t){t&&we(ro,e)}(e,t):o&&function(e,t){t&&we(go,e)}(e,o)};Se("hexagon-element",(e=>{var t,o,i;tt(e,(()=>{e.addEventListener("click",(()=>we(Zt,{item:"hexagon",row:e.row,col:e.col})))}));const{row:n,col:r}=e,{get:s,set:a}=ot(e,{elements:e.elements,row:n,col:r}),{get:l,set:c}=ot(e,void 0),{get:d,set:u}=ot(e,void 0);$e(e,eo,(e=>(null==e?void 0:e.row.toString())===n.toString()&&(null==e?void 0:e.col.toString())===r.toString()),a),$e(e,oo,c),$e(e,mo,u),$e(e,ro,(()=>c(void 0))),$e(e,io,(()=>c(void 0))),$e(e,fo,(()=>u(void 0)));const h=s();return R`<div 
      class="hexagon ${$i(e,l(),d())}" 
      @mouseover=${()=>{l()&&we(no,{row:n,col:r})}}
      ...
      ${bi(h.elements,e.row,e.col)}</div>`}),{styles:[wi,yi],defaults:{background:void 0,elements:[],col:0,row:0}}),Se("world-map",(e=>{var t;const{get:o,set:i}=ot(e,void 0);return $e(e,Rt,i),R`<div id="globe">${null===(t=o())||void 0===t?void 0:t.map.map(((e,t)=>R`<div class="row ${t%2==0?"push":""}" style="width: calc(${120*e.length}px + 20rem)">
    ...
    .push {
        margin-left: 60px;
    }`});const xi="building-mill";var Oi=Se(xi,(({team:e})=>R`<div style="background-image:url('/assets/windmill_complete_${null!=e?e:"none"}.png'"></div>`),{styles:[ei,a`
        div {
            width: 80%;
            height: 80%;
        }
        `],defaults:{team:void 0}}),ji=Object.freeze({__proto__:null,name:xi,default:Oi});const _i="building-castle-small";var Si=Se(_i,(e=>{const{get:t,set:o}=ot(e,"");return $e(e,_o,o),R`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/castle_small_${e.team}.png'"></div>`}),{styles:[ei,ti,a`
        :host {
            filter: hue-rotate(0deg);
        }
        `],defaults:{team:"",row:void 0,col:void 0}}),Ei=Object.freeze({__proto__:null,name:_i,default:Si});const Ai="lumberjack-small";var Ti=Se(Ai,(e=>{const{get:t,set:o}=ot(e,"");return $e(e,_o,o),R`<div class="${t()===e.team?"active":"inactive"}" style="margin: 0; background-image:url('/assets/lumberjack_small_${e.team}.png'); background-size: auto; width: 100%; height: 100%;"></div>`}),{styles:[ei,ti,a`
        :host {
            filter: hue-rotate(0deg);
        }
        `],defaults:{team:"",row:void 0,col:void 0}}),Mi=Object.freeze({__proto__:null,name:Ai,default:Ti});const Ci="mine-small";var zi=Se(Ci,(e=>{const{get:t,set:o}=ot(e,"");return $e(e,_o,o),R`<div class="${t()===e.team?"active":"inactive"}" style="margin: 0; background-image:url('/assets/mine_small_${e.team}.png'); background-size: auto; width: 100%; height: 100%;"></div>`}),{styles:[ei,ti,a`
        :host {
            filter: hue-rotate(0deg);
        }
        `],defaults:{team:"",row:void 0,col:void 0}}),Ri=Object.freeze({__proto__:null,name:Ci,default:zi});const Hi={hay:0,iron:0,grain:0,wood:0,stone:0};var Ni=Bo,Ui=Ho,Bi=()=>Object.assign(Object.assign({},Hi),{stone:4,wood:2,grain:1}),Pi=()=>Object.assign(Object.assign({},Hi),{wood:500,grain:500,stone:500}),Di=()=>Object.assign(Object.assign({},Hi),{stone:1e3,iron:1e3,grain:1e3});const Ii=a`
  :host {
    display: block;
  ...
  `;Se("health-bar",(({health:{current:e,max:t}})=>R`<loading-bar id="health" width="${e/t*100}%"></loading-bar>`));const Li=e=>parseInt(e.toString(),10),Yi=ne`
  header {
    display: grid;
    grid-template-areas: 
...
`,Gi=(e,t)=>R`
  ...
  `;Se("sidebar-castle",(e=>{var t;const{selected:{payload:o,row:i,col:n}}=e,{team:r,health:s,actions:a}=o,l={row:Li(i),col:Li(n)},{get:c,set:d}=ot(e,void 0);$e(e,Gt,d);const{resources:u}=null!==(t=c())&&void 0!==t?t:{resources:{}};return R`
      <header>
      ...
      <div class="container">
        <button-image
          ...
          @click=${async()=>await we(Vt,{team:r,row:i,col:n,origin:o})}
        >
          ${Gi(u,Ui())}
        </button-image>
        <button-image
          ...
          @click=${async()=>await we(qt,{team:r,row:i,col:n,origin:o})}
        >
          ${Gi(u,Ni())}
        </button-image>
      ...
      </div>`}),{styles:[Ii,Yi],defaults:{selected:{payload:{id:"",name:_i,team:"",health:{current:0,max:0},actions:{current:0,max:0}},col:0,row:0}}});Se("sidebar-knight",(e=>{const{selected:{payload:t,row:o,col:i}}=e,{health:n,actions:r}=t,s={row:Li(o),col:Li(i)};return R`
    <h3>${vt(ht.knight)}</h3>
    <div class="container">
        ...
        <button ?disabled=${r.current<1} id="move" title="${vt(ht.properties.actions.move)}" @click=${()=>we(to,{asset:Object.assign({},t),start:s})}>🦵</button>
...
`],props:[{selected:{type:Object}}]});const Wi=a`
    :host {
        display: block;
        background-image: url('/assets/sidebar/bg.png');
        background-size: 100% 100%;
...
`;ge.on(ao,((...e)=>console.log("BuildLumberjackSmallSuccess",...e))),ge.on(lo,console.error),ge.on(so,((...e)=>console.log("BuildLumberjackSmall",...e))),Se("sidebar-wagon",(e=>{const{selected:{payload:t,row:o,col:i}}=e,{health:n,actions:r}=t,s={row:Li(o),col:Li(i)};return R`
    <h3>${vt(ht.wagon)}</h3>
    <div class="container">
        ...
        <stats-bar id="stats" .health="${n}" .actions="${r}"></stats-bar>
        <button ?disabled=${r.current<1} id="move"  title="${vt(ht.properties.actions.move)}" @click=${()=>we(to,{asset:Object.assign({},t),start:s})}>🦵</button>
        <button ?disabled=${r.current<1} id="build_lumberjack" title="${vt(ht.properties.actions.build.lumberjack_small)}" @click=${()=>we(so,{asset:Object.assign({},t),position:s})}>
            <img id="build_lumberjack_small" src="/assets/lumberjack_small_${t.team}.png">
        </button>
        <button ?disabled=${r.current<1} id="build_mine" title="${vt(ht.properties.actions.build.mine_small)}" @click=${()=>we(co,{asset:Object.assign({},t),position:s})}>
    ...
    </div>`}),{styles:[Wi],props:[{selected:{type:Object}}]}),Se("stats-bar",(({health:e,actions:t})=>R`${gi(vt(ht.properties.life,e.current,e.max))}<br>
    ${gi(vt(ht.properties.actions,t.current,t.max))}`)),Se("button-attack",(({actions:e,asset:t,position:o})=>R`<button ?disabled=${e.current<1} id="attack" title="${vt(ht.properties.actions.attack)}" @click=${()=>we(vo,{asset:Object.assign({},t),start:o})}>⚔</button>
    `));const Zi=e=>({position:e?new lt(null==e?void 0:e.row,null==e?void 0:e.col):void 0,elements:e?[{item:e.item,payload:e.payload}]:[],dirty:!1});Se("controls-sidebar",(async e=>{const{get:t,set:o}=ot(e,void 0);$e(e,Zt,o);const i=t(),{get:n,set:r}=ot(e,Zi(i)),s=n();return!s.dirty&&i&&new lt(i.row,i.col).equals(s.position)?r(Object.assign(Object.assign({},s),{elements:[...s.elements,{item:i.item,payload:i.payload}],dirty:"hexagon"===i.item})):r(Zi(i)),tt(e,(()=>{setTimeout((()=>{we(Nt)}),1)})),R`
    ...
    `}),{styles:a`:host { 
        ...
        top: 20px;
        z-index: 2;
    }`}),Se("modal-battle",(e=>{var t,o;const{get:i,set:n}=ot(e,void 0),{get:r,set:s}=ot(e,void 0);return $e(e,xo,n),R`
   <modal-window 
        .open=${!!i()} 
        preventClose>
        ...
        <p slot="footer">
            <button @click="${()=>{var e,t;return we(bo,{attacker:{asset:null===(e=i())||void 0===e?void 0:e.attacker[0],dices:[r()]},defender:null===(t=i())||void 0===t?void 0:t.defender[0],location:{row:i().location.row,col:i().location.col}})}}" ?disabled="${void 0===r()}">Würfeln</button>
        </p>
        ...
        `]}),Se("modal-dice-result",(e=>{const{get:t,set:o}=ot(e,void 0),i=ot(e,[]),n=ot(e,[]);let r=setTimeout((()=>{}),1);return $e(e,Oo,(e=>{o(e),i.set(e.attacker),n.set(e.defender),clearTimeout(r),r=setTimeout((()=>{i.set(e.attacker_after),n.set(e.defender_after)}),5e3)})),R`
   <modal-window 
        .open=${!!t()} 
        @close=${()=>o(void 0)}>
        ...
        `]}),Se("modal-mill-taken",(e=>{var t,o,i,n,r;const{get:s,set:a}=ot(e,void 0);return $e(e,yo,a),R`
    <modal-window 
         .open=${!!s()} 
         @close=${()=>a(void 0)}>
    ...
    `}),Se("modal-no-more-turns",(e=>{const{getState:t,publish:o}=ot(e,void 0);return $e(e,Qt,o),R`
   <modal-window 
        .open=${!!t()} 
        preventClose>
        ...
        <p slot="footer">
            <button @click="${()=>(we(So),o(!1))}">Zug beenden</button>
    ...
    <modal-mill-taken></modal-mill-taken>`)),Se("footer-element",(o=>{const{get:i,set:n}=ot(o,void 0),{get:r,set:s}=ot(o,[]);return $e(o,_o,n),$e(o,Xt,s),R`<footer class="${i()}">
    <div class="main ">
        ${((o,i="")=>{const n=null==o?void 0:o.map((o=>{var n,r;const s=Object.entries(Object.assign(Object.assign({},t),e)).find((([e,t])=>t.name===o.name)),a=Object.entries(Object.assign(Object.assign({},o),{name:void 0})).filter((([e,t])=>void 0!==t)).map((([e,t])=>`${e}="${t}"`)).join(" "),l=$t(o)?{row:o.row,col:o.col}:{row:0,col:0};return R`<div
            @click="${()=>{we(Wt,Object.assign(Object.assign({item:o.name},l),{payload:o})),setTimeout((()=>{var e;null===(e=Uo(o))||void 0===e||e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}),2)}}"
            @mouseover="${()=>{setTimeout((()=>{var e;null===(e=Uo(o))||void 0===e||e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}),2)}}"
...
`;var Vi;Se("resource-grain",(()=>R`<div title="${vt(ut.grain)}"></div>`),{styles:[a`
        :host {
          background-image: url("/assets/resources/grain.png");
        }
      `,Ki]}),Se("resource-stone",(()=>R`<div title="${vt(ut.stone)}"></div>`),{styles:[a`
        :host {
          background-image: url("/assets/resources/stone.png");
        }
      `,Ki]}),Se("resource-iron",(()=>R`<div title="${vt(ut.iron)}"></div>`),{styles:[a`
        :host {
          background-image: url("/assets/resources/iron.png");
        }
      `,Ki]}),Se("resource-wood",(()=>R`<div title="${vt(ut.log)}"></div>`),{styles:[a`
        :host {
          background-image: url("/assets/resources/log.png");
        }
      `,Ki]}),Se("resource-hay",(()=>R`<div title="${vt(ut.hay)}"></div>`),{styles:[a`
        :host {
          background-image: url("/assets/resources/hay.png");
        }
      `,Ki]}),Se("resource-counter",(({count:e,collect:t})=>R`
        <slot></slot>
        ${e} ${t?R`<span>(+${t})</span>`:""}
    `),{styles:[a`
        :host {
        ...
        `],defaults:{count:0,collect:void 0}}),Se("header-element",(e=>{var t,o,i,n,r,s,a,l;const{get:c,set:d}=ot(e,void 0),{get:u,set:h}=ot(e,void 0),{get:v,set:m}=ot(e,void 0);$e(e,_o,d),$e(e,Gt,h),$e(e,Ro,m);const g=null!==(t=u())&&void 0!==t?t:{resources:{}},f=(e,t,o)=>(e[t]=(e[t]||0)+o,e),p=null!==(i=null===(o=v())||void 0===o?void 0:o.resourcesToGenerate.reduce(((e,t)=>{var o,i;for(const n of wt)e=f(e,n,null!==(i=null===(o=t.resources[n])||void 0===o?void 0:o.generatedResource)&&void 0!==i?i:0);return e}),{}))&&void 0!==i?i:{};return R`<header class="${c()}">
        <resource-counter title="${vt(ut.hay)}" count="${g.resources.hay}" collect=${null!==(n=p.hay)&&void 0!==n?n:0}>
            <resource-hay></resource-hay>
        </resource-counter>
        <resource-counter title="${vt(ut.grain)}" count="${g.resources.grain}" collect=${null!==(r=p.grain)&&void 0!==r?r:0}>
            <resource-grain></resource-grain>
        </resource-counter>
        <resource-counter title="${vt(ut.stone)}" count="${g.resources.stone}" collect=${null!==(s=p.stone)&&void 0!==s?s:0}>
            <resource-stone></resource-stone>
        </resource-counter>
        <resource-counter title="${vt(ut.iron)}" count="${g.resources.iron}" collect=${null!==(a=p.iron)&&void 0!==a?a:0}>
            <resource-iron></resource-iron>
        </resource-counter>
        <resource-counter title="${vt(ut.log)}" count="${g.resources.wood}" collect=${null!==(l=p.wood)&&void 0!==l?l:0}>
            <resource-wood></resource-wood>
        </resource-counter>
    </header>`}),{styles:ne`
    header {
    ...
    `]});const qi=window.location.search.substring(1).split("&").reduce(((e,t)=>{const[o,i]=t.split("=");return e[o]=i,e}),{});document.documentElement.lang=qi.lang||"en";export{t as buildings,ci as knight,e as player,hi as wagon};
