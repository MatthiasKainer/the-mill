var e=Object.freeze({__proto__:null,get knight(){return Do},get wagon(){return Yo}}),t=Object.freeze({__proto__:null,get mill(){return ii},get castleSmall(){return si},get lumberjackSmall(){return ci}});
/**
 * @license
...
`,props:[{result:{type:Number}}]});const Po="player-knight";var Lo=$e(Po,(e=>{const{getState:t,publish:o}=Ke(e,"");return pe(e,ro,o),T`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/knight_${e.team}.png'"></div>`}),{styles:[zo,To,s`
        div {
            background-size: contain;
            opacity: 1;
        }
        `],defaults:{team:""}}),Do=Object.freeze({__proto__:null,name:Po,default:Lo});const Wo="player-wagon";var Zo=$e(Wo,(e=>{const{getState:t,publish:o}=Ke(e,"");return pe(e,ro,o),T`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/wagon_${e.team}.png'"></div>`}),{styles:[zo,To,s`
        div {
            background-size: contain;
            opacity: 1;
        }
        `],defaults:{team:""}}),Yo=Object.freeze({__proto__:null,name:Wo,default:Zo});$e("dice-selector",(e=>{var t;return T`${null===(t=e.dices)||void 0===t?void 0:t.map((t=>T`<div>
        <input type="radio" 
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class Io extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){if(super(e),this.it=H,e.type!==qo)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===H||null==e)return this.ft=void 0,this.it=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Io.directiveName="unsafeHTML",Io.resultType=1;const Xo=(e=>(...t)=>({_$litDirective$:e,values:t}))(Io);async function Go(e){for(const t of e)await t()}const Fo=(e,t)=>{var o,i;return[...null!==(o=t.none)&&void 0!==o?o:[],...null!==(i=t[e])&&void 0!==i?i:[]]};$e("sprite-set",(e=>{const{getState:t,publish:o}=Ke(e,void 0),{getState:i,publish:r}=Ke(e,void 0);return pe(e,Pt,(t=>e.row.toString()===(null==t?void 0:t.row.toString())&&e.col.toString()===(null==t?void 0:t.col.toString())),o),pe(e,ro,r),t()&&Go(Fo(i(),e.triggers)).then((()=>ve(zt,{item:"hexagon",row:e.row,col:e.col}))),Fe(e,(()=>{e.addEventListener("click",(async()=>{Go(Fo(i(),e.triggers))}))})),T`<slot></slot>`}),{defaults:{row:0,col:0,triggers:{}}}),$e("sprite-player-elements-grid",(()=>T`<slot></slot>`),{styles:s`
    slot {
        display: grid;
        align-items: center;
...
`,Qo=(e,t,o)=>`${function(e,t){var o,i;return t?tt(t.start,e)?"active start":t.end&&(null!==(i=null===(o=t.trail)||void 0===o?void 0:o.length)&&void 0!==i?i:0)<1&&tt(t.end,e)?"active unreachable":t.end&&tt(t.end,e)?"active end":t.trail&&t.trail.some((t=>tt(t,e)))?"active trail":"inactive":""}(e,t)} ${function(e,t){return t?tt(t.start,e)?"active start":t.end&&tt(t.end,e)?"active end":t.range&&t.range.some((t=>tt(t,e)))?"active trail":"inactive":""}(e,o)}`,ei=(e,t,o)=>{t&&t.end&&tt(t.end,e)?function(e,t){t&&ve(Zt,e)}(e,t):o&&function(e,t){t&&ve(Ft,e)}(e,o)};$e("hexagon-element",(e=>{var t,o,i;Fe(e,(()=>{e.addEventListener("click",(()=>ve(zt,{item:"hexagon",row:e.row,col:e.col})))}));const{row:r,col:n}=e,{get:s,set:a}=Ke(e,{elements:e.elements,row:r,col:n}),{get:l,set:c}=Ke(e,void 0),{get:d,set:u}=Ke(e,void 0);pe(e,Pt,(e=>(null==e?void 0:e.row.toString())===r.toString()&&(null==e?void 0:e.col.toString())===n.toString()),a),pe(e,Lt,c),pe(e,Gt,u),pe(e,Zt,(()=>c(void 0))),pe(e,Dt,(()=>c(void 0))),pe(e,Kt,(()=>u(void 0)));const h=s();return T`<div 
      ...
      ${Ko(h.elements,e.row,e.col)}</div>`}),{styles:[Jo,Vo],defaults:{background:void 0,elements:[],col:0,row:0}}),$e("world-map",(e=>{var t;const{get:o,set:i}=Ke(e,void 0);return pe(e,$t,i),T`<div id="globe">${null===(t=o())||void 0===t?void 0:t.map.map(((e,t)=>T`<div class="row ${t%2==0?"push":""}" style="width: calc(${120*e.length}px + 20rem)">
...
`;ce.on(qt,((...e)=>console.log("BuildLumberjackSmallSuccess",...e))),ce.on(It,console.error),ce.on(Yt,((...e)=>console.log("BuildLumberjackSmall",...e))),$e("sidebar-wagon",(e=>{const{selected:{payload:t,row:o,col:i}}=e,{health:r,actions:n}=t,s={row:ki(o),col:ki(i)};return T`
    <h3>${bi(fi.wagon)}</h3>
    <div class="container">
        ...
        <button ?disabled=${n.current<1} id="move"  title="${bi(fi.properties.actions.move)}" @click=${()=>ve(Lt,{asset:Object.assign({},t),start:s})}>🦵</button>
        <button ?disabled=${n.current<1} id="build_lumberjack" title="${bi(fi.properties.actions.build.lumberjack_small)}" @click=${()=>ve(Yt,{asset:Object.assign({},t),position:s})}>
    ...
    </div>`}),{styles:[xi],props:[{selected:{type:Object}}]});const ji=e=>({position:e?new ot(null==e?void 0:e.row,null==e?void 0:e.col):void 0,elements:e?[{item:e.item,payload:e.payload}]:[],dirty:!1});$e("controls-sidebar",(e=>{const{get:t,set:o}=Ke(e,void 0);pe(e,zt,o);const i=t(),{get:r,set:n}=Ke(e,ji(i)),s=r();return!s.dirty&&i&&new ot(i.row,i.col).equals(s.position)?n(Object.assign(Object.assign({},s),{elements:[...s.elements,{item:i.item,payload:i.payload}],dirty:"hexagon"===i.item})):n(ji(i)),Fe(e,(()=>{setTimeout((()=>{ve(xt)}),1)})),T`
...
`;var _i;$e("resource-grain",(()=>T`<div title="${bi(mi.grain)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/grain.png");
        }
      `,Oi]}),$e("resource-stone",(()=>T`<div title="${bi(mi.stone)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/stone.png");
        }
      `,Oi]}),$e("resource-iron",(()=>T`<div title="${bi(mi.iron)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/iron.png");
        }
      `,Oi]}),$e("resource-wood",(()=>T`<div title="${bi(mi.log)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/log.png");
        }
      `,Oi]}),$e("resource-hay",(()=>T`<div title="${bi(mi.hay)}"></div>`),{styles:[s`
        :host {
    ...
    `),{styles:[s`
        ...
        `],defaults:{count:0,collect:void 0}}),$e("header-element",(e=>{var t,o,i,r,n,s,a,l;const{get:c,set:d}=Ke(e,void 0),{get:u,set:h}=Ke(e,void 0),{get:v,set:g}=Ke(e,void 0);pe(e,ro,d),pe(e,At,h),pe(e,vo,g);const p=null!==(t=u())&&void 0!==t?t:{resources:{}},m=(e,t,o)=>(e[t]=(e[t]||0)+o,e),f=null!==(i=null===(o=v())||void 0===o?void 0:o.resourcesToGenerate.reduce(((e,t)=>{var o,i;for(const r of lt)e=m(e,r,null!==(i=null===(o=t.resources[r])||void 0===o?void 0:o.generatedResource)&&void 0!==i?i:0);return e}),{}))&&void 0!==i?i:{};return T`<header class="${c()}">
        <resource-counter title="${bi(mi.hay)}" count="${p.resources.hay}" collect=${null!==(r=f.hay)&&void 0!==r?r:0}>
            <resource-hay></resource-hay>
        </resource-counter>
        <resource-counter title="${bi(mi.grain)}" count="${p.resources.grain}" collect=${null!==(n=f.grain)&&void 0!==n?n:0}>
            <resource-grain></resource-grain>
        </resource-counter>
        <resource-counter title="${bi(mi.stone)}" count="${p.resources.stone}" collect=${null!==(s=f.stone)&&void 0!==s?s:0}>
            <resource-stone></resource-stone>
        </resource-counter>
        <resource-counter title="${bi(mi.iron)}" count="${p.resources.iron}" collect=${null!==(a=f.iron)&&void 0!==a?a:0}>
            <resource-iron></resource-iron>
        </resource-counter>
        <resource-counter title="${bi(mi.log)}" count="${p.resources.wood}" collect=${null!==(l=f.wood)&&void 0!==l?l:0}>
            <resource-wood></resource-wood>
        </resource-counter>
    </header>`}),{styles:s`
    header {
    ...
    `]});const Si=window.location.search.substring(1).split("&").reduce(((e,t)=>{const[o,i]=t.split("=");return e[o]=i,e}),{});document.documentElement.lang=Si.lang||"en";export{t as buildings,Do as knight,e as player,Yo as wagon};
