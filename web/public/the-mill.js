var e=Object.freeze({__proto__:null,get knight(){return Do},get wagon(){return qo}}),t=Object.freeze({__proto__:null,get mill(){return ii},get castleSmall(){return si},get lumberjackSmall(){return ci}});
/**
 * @license
...
***************************************************************************** */
function at(e,t){var o={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(o[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var r=0;for(i=Object.getOwnPropertySymbols(e);r<i.length;r++)t.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(e,i[r])&&(o[i[r]]=e[i[r]])}return o}const lt=["hay","grain","iron","wood","stone"];function ct(e){var t;return void 0!==e&&void 0!==(null===(t=e)||void 0===t?void 0:t.resources)}function dt(e){var t,o;return void 0!==e&&(null===(t=e)||void 0===t?void 0:t.row)>=0&&(null===(o=e)||void 0===o?void 0:o.col)>=0}function ut(e){var t,o;return e&&(null===(o=null===(t=e)||void 0===t?void 0:t.actions)||void 0===o?void 0:o.max)>0}function ht(e){var t,o;return e&&(null===(o=null===(t=e)||void 0===t?void 0:t.dices)||void 0===o?void 0:o.length)>0}const vt={id:"building-mill",name:"Mill",occurences:{min:1},resources:{grain:{hay:100,generatedResource:50},hay:{generatedResource:50}}};function gt(e){return void 0!==e&&e.max>0}const mt=[Object.assign(Object.assign({},vt),{min:0,max:2}),Object.assign(Object.assign({},vt),{min:8,max:10})],pt=({min:e,max:t},o,i)=>{const r=e=>o*i*(e/10);return Math.floor(Math.random()*(r(t)-r(e))+r(e))},ft=(e,t)=>{var o;return null===(o=null==e?void 0:e.map)||void 0===o?void 0:o.reduce(((e,o)=>[...e,...o.reduce(((e,o)=>[...e,...o.elements.filter(ct).filter((e=>e.team===t))]),[])]),[])},bt=(...e)=>e.reduce(((e,t)=>(e.push(...Object.entries(t.resources).map((e=>{var[o,i]=e,{generatedResource:r}=i,n=at(i,["generatedResource"]);let s={};s[o]=Object.assign(Object.assign({},n),{generatedResource:r});return Object.assign(Object.assign({},t),{resources:s})}))),e)),[]).filter(Boolean),wt={gras:{sprite:{name:"gras",file:"hexagonTerrain_sheet",x:414,y:1906},movementCosts:1,defense:0},desert:{sprite:{name:"desert",file:"hexagonTerrain_sheet",x:902,y:627},movementCosts:4,defense:0},mud:{sprite:{name:"mud",file:"hexagonTerrain_sheet",x:658,y:912},movementCosts:4,defense:1},muddyHills:{sprite:{name:"muddyHills",file:"hexagonTerrain_sheet",x:780,y:627},movementCosts:8,defense:3},forest:{sprite:{name:"forest",file:"hexagonTerrain_sheet",x:536,y:912},movementCosts:8,defense:3},mountain:{sprite:{name:"mountain",file:"hexagonTerrain_sheet",x:414,y:1052},movementCosts:10,defense:9}},yt=()=>{const e=Object.keys(wt);return wt[e[Math.floor(Math.random()*(e.length-1))]]},$t=ue("game/world/worldLoaded"),kt=ue("game/start"),xt=ue("game/load/sidebar"),jt=({rows:e,cols:t})=>(e=>{const t=new Array(e.rows*e.cols).map((()=>[]));return mt.forEach((o=>{var i;let r=o.occurences.factor?Math.max(o.occurences.min,t.length/o.occurences.factor):o.occurences.min;for(;r>0;){const s=gt(o)?pt(o,e.rows,e.cols):(n=t.length,Math.round(Math.random()*(n-1)));t[s]=[...null!==(i=t[s])&&void 0!==i?i:[],Object.assign(Object.assign({},o),{name:o.id,id:rt()})],r--}var n})),t})({rows:e,cols:t}),Ot=(e,{rows:t,cols:o})=>((e,t)=>{const o=new Array(t.rows*t.cols).map((()=>[]));return[nt].forEach((t=>{var i;let r=t.occurences.factor?Math.max(t.occurences.min,o.length/t.occurences.factor):t.occurences.min;for(;r>0;){const n=st[e](o);o[n]=[...null!==(i=o[n])&&void 0!==i?i:[],{name:t.id,team:e,id:rt(),resources:t.resources}],r--}})),o})(e,{rows:t,cols:o}),_t=(e,t,o)=>{var i;return(null!==(i=e.pop())&&void 0!==i?i:[]).map((e=>Object.assign(Object.assign({},e),{row:t,col:o})))};class St{constructor(e=4086,t=Uint32Array){this.capacity=e,this.capacity=e,this._keys=[],this._priorities=new t(e+1),this.length=0}clear(){this.length=0}bubbleUp(e){const t=this._keys[e],o=this._priorities[e];for(;e>1;){const t=e>>>1;if(this._priorities[t]<=o)break;this._keys[e]=this._keys[t],this._priorities[e]=this._priorities[t],e=t}this._keys[e]=t,this._priorities[e]=o}bubbleDown(e){const t=this._keys[e],o=this._priorities[e],i=1+(this.length>>>1),r=this.length+1;for(;e<i;){const t=e<<1;if(t>=r)break;let i=this._priorities[t],n=this._keys[t],s=t;const a=t+1;if(a<r){const e=this._priorities[a];e<i&&(i=e,n=this._keys[a],s=a)}if(i>=o)break;this._keys[e]=n,this._priorities[e]=i,e=s}this._keys[e]=t,this._priorities[e]=o}push(e,t=0){if(this.length===this.capacity)throw new Error("Heap has reached capacity, can't push new items");const o=this.length+1;this._keys[o]=e,this._priorities[o]=t,this.bubbleUp(o),this.length++}pop(){const e=this._keys[1];return this.length--,this.length>0&&(this._keys[1]=this._keys[this.length+1],this._priorities[1]=this._priorities[this.length+1],this.bubbleDown(1)),e}peekPriority(){return this._priorities[1]}peek(){return this._keys[1]}toString(){if(0===this.length)return"(empty queue)";const e=Array(this.length-1);for(let t=0;t<this.length;t++)e[t]=this._priorities[t+1];return`[${e.join(" ")}]`}get[Symbol.toStringTag](){return"Heapify"}*[Symbol.iterator](){for(let e=0;e<this.length;e++){const t=this._priorities[e+1],o=this._keys[e+1];yield[o,t]}}*keys(){for(let e=0;e<this.length;e++)yield this._keys[e+1]}*priorities(){for(let e=0;e<this.length;e++)yield this._priorities[e+1]}}const Mt=e=>e.toPosition().toString(),Et=de("action/abort"),At=ue("player/update"),Ct=de("player/request/select"),zt=ue("player/buildings/item/selected"),Tt=ue("player/item/moved"),Rt=ue("player/knights/created"),Ht=ue("player/wagon/created"),Ut=ue("player/assets/loaded"),Nt=ue("turn/player/actions/hasLeft"),Bt=de("turn/player/actions/none"),Pt=de("map/hexagon/updated",{readOnce:!0}),Lt=ue("modes/move/activate"),Dt=ue("modes/move/deactivate"),Wt=ue("modes/move/hovered-target"),Zt=ue("modes/move/end"),qt=ue("modes/build/lumberjack-small"),Yt=ue("modes/build/lumberjack-small/success"),It=ue("modes/build/lumberjack-small/failed"),Xt=ue("modes/battle/activate"),Gt=ue("modes/battle/active"),Ft=ue("modes/battle/end"),Kt=ue("modes/battle/deactivate"),Jt=ue("battle/started"),Vt=ue("battle/dice/thrown"),Qt=ue("battle/player/attacked"),eo=ue("mill/takeover"),to=ue("modal/battle/open"),oo=ue("modal/dice-result/open"),io=ue("turn/world/started"),ro=ue("turn/world/accepted"),no=ue("turn/player/complete"),so=ue("turn/world/complete"),ao=ue("resources/generated"),lo=ue("resources/generation/complete"),co=ue("resources/summary"),uo=ue("resources/distribute"),ho=ue("resources/distribute/request"),vo=ue("resources/distribute/updated");function go(e){return e.reduce(((e,t)=>e+function(e){return e.sides[Math.floor(Math.random()*e.sides.length)].value}(t)),0)}const mo=()=>({grain:100,iron:200,hay:0,wood:0,stone:0});function po(e,t){if(!e||!e.map)return[];const o=e=>t===e.team,i=[];for(const t of e.map)for(const e of t)i.push(...e.elements.filter(o));return i}function fo(e){var t,o,i,r,n;if(!e)return;return[...null!==(n=null===(r=null===(i=null===(o=null===(t=null===document||void 0===document?void 0:document.querySelector("the-mill"))||void 0===t?void 0:t.shadowRoot)||void 0===o?void 0:o.querySelector("world-map"))||void 0===i?void 0:i.shadowRoot)||void 0===r?void 0:r.querySelectorAll("hexagon-element"))&&void 0!==n?n:[]].find((t=>{var o,i;return null===(i=null===(o=t.shadowRoot)||void 0===o?void 0:o.querySelector("sprite-set"))||void 0===i?void 0:i.querySelector(`[id="${e.id}"]`)}))}document.deepQuerySelector=fo;const bo=()=>({grain:50,iron:0,hay:0,wood:50,stone:0});let wo,yo={},$o=[],ko=[],xo={};const jo=e=>Object.assign({},xo[e]),Oo=()=>xo[wo],_o=e=>e.actions.current>0,So=({team:e})=>e===wo;ce.on($t,(async e=>{$o=[],e.map.forEach(((e,t)=>{e.forEach(((e,o)=>{const i=new ot(t,o).toCube();e.terrain.movementCosts&&(i.costs=e.terrain.movementCosts),$o.push(i)}))})),yo=e,["green","red"].forEach((e=>{xo[e]={resources:{hay:100,grain:200,iron:200,wood:100,stone:100}}})),await ve(kt)})),ce.on(Et,(async e=>{e&&(ve(Dt),ve(Kt))})),ce.on([kt,xt],(async()=>{await ve(io)})),ce.on(io,(async()=>{ko=[...yo.teams],wo=ko.pop(),await ve(ro,wo)})),ce.on(uo,(async({team:e,resourcesToGenerate:t})=>{var o;if(null===(o=jo(e))||void 0===o?void 0:o.resources){const o=Object.assign({},jo(e).resources);xo[e].resources=function(e,t){let o=Object.assign({},e),i=[...t],r=!0;for(;r;)r=!1,i=i.map((e=>{let t=e;return Object.entries(e.resources).forEach((i=>{var[n,s]=i,{generatedResource:a}=s,l=at(s,["generatedResource"]);Object.entries(l).every((([e,t])=>o[e]<=t))&&(r=!0,t=void 0,Object.entries(l).forEach((([e,t])=>{o[e]-=t})),o[n]+=a,ve(ao,e))})),t})).filter(Boolean);return o}(xo[e].resources,t),ve(lo,{team:e,before:o,after:xo[e].resources})}})),ce.collect(ao,lo,(e=>{var t;ve(co,null===(t=e[ao.name])||void 0===t?void 0:t.map((e=>({name:e.name,from:Object.values(e.resources).map((e=>{var t=at(e,["generatedResource"]);return Object.assign({},t)})),to:Object.keys(e.resources)}))))})),ce.on(ro,(async e=>{const t=po(yo,e);await ve(Ut,t);const o=null==t?void 0:t.find((e=>e.name===ri));dt(o)&&ve(Ct,{item:ri,row:o.row,col:o.col,payload:o}),setTimeout((()=>{var e;null===(e=fo(o))||void 0===e||e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}),2),ve(At,jo(e));const i=ft(yo,e).reduce(((e,t)=>[...e,...bt(t)]),[]);ve(vo,{team:e,resourcesToGenerate:i}),await ve(uo,{team:e,resourcesToGenerate:i})})),ce.on(ho,(({team:e})=>{const t=ft(yo,e).reduce(((e,t)=>[...e,...bt(t)]),[]);ve(vo,{team:e,resourcesToGenerate:t})})),ce.on(Ct,(async e=>{await ve(zt,Object.assign(Object.assign({},e),{item:"hexagon"})),console.log("RequestSelectCoords",e),await ve(zt,Object.assign({},e))})),ce.on(no,(()=>{wo=ko.pop(),void 0===wo?ve(so):ve(ro,wo)})),ce.on(so,(()=>{yo.map.forEach((e=>{e.forEach((({elements:e})=>{((...e)=>{e.forEach((e=>{e.actions.current=e.actions.max}))})(...e.filter(ut))}))})),ve(io)}));const Mo=(e,t)=>{const o=Object.assign({},xo[e].resources);for(const[e,i]of Object.entries(t)){if(o[e]<i)return!1;o[e]-=i}return xo[e].resources=o,!0};ce.on(Rt,(async({row:e,col:t,team:o})=>{if(!So({team:o}))return;if(!Mo(o,{grain:100,iron:200,hay:0,wood:0,stone:0}))return;const i=(({team:e,row:t,col:o})=>({id:rt(),name:Po,team:e,row:t,col:o,movement:{points:10},actions:{current:2,max:2},health:{current:10,max:10},dices:[{name:"Standardwaffe",story:"Eine faire, ausgewogene Waffe die jeder Ritter haben sollte",sides:[{value:3},{value:3},{value:3},{value:4},{value:5},{value:6}]},{name:"Mächtiger Schlag des Betrugs",story:"Eine Waffe, die bis zu 12 Schaden verursachen kann, doch auch eine hohe Wahrscheinlichkeit hat gar keinen Schaden zu verursachen, oder sogar den Ritter selbst zu verletzen!",sides:[{value:-3},{value:0},{value:0},{value:6},{value:12}]}]}))({row:e,col:t,team:o});yo.map[e][t].elements.push(i),await Promise.all([ve(Pt,{row:e,col:t,elements:[...yo.map[e][t].elements]}),ve(Ut,po(yo,o)),ve(At,Oo())]),ve(Ct,{item:i.name,row:e,col:t,payload:i})})),ce.on(Ht,(async({row:e,col:t,team:o})=>{if(!So({team:o}))return;if(!Mo(o,{grain:50,iron:0,hay:0,wood:50,stone:0}))return;const i=(({team:e,row:t,col:o})=>({id:rt(),name:Wo,team:e,row:t,col:o,movement:{points:10},actions:{current:2,max:2},health:{current:10,max:10}}))({row:e,col:t,team:o});yo.map[e][t].elements.push(i),await Promise.all([ve(Pt,{row:e,col:t,elements:[...yo.map[e][t].elements]}),ve(Ut,po(yo,o)),ve(At,Oo())]),ve(Ct,{item:i.name,row:e,col:t,payload:i})})),ce.on(Nt,(()=>{void 0===((e,t)=>{for(const o of e.map)for(const e of o){const o=e.elements.filter(ut).map((e=>e)).find((e=>e.team===t&&e.actions.current>0));if(o)return o}})(yo,wo)&&ve(Bt,!0)})),ce.on(qt,(async({position:e,asset:t})=>{const{elements:o,terrain:i}=yo.map[e.row][e.col],{team:r}=t,n=o.findIndex((e=>"player-wagon"===e.name));if(So({team:t.team}))if("player-wagon"!==t.name||n<0)await ve(It,{position:e,asset:t,reason:"No wagon on field"});else if(function(e,t){return e.sprite.name===t}(i,"forest"))if(o.some(ct))await ve(It,{position:e,asset:t,reason:"There is already a building on the field"});else{const i=(({position:e,asset:t})=>Object.assign(Object.assign({id:"lumberjack-small",name:"lumberjack-small",team:t.team},e),{occurences:{min:1},resources:{wood:{generatedResource:50}}}))({position:e,asset:t});o.splice(n,1),o.unshift(i),await Promise.all([ve(Pt,Object.assign(Object.assign({},e),{elements:[...o]})),ve(Ut,po(yo,t.team)),ve(At,Oo()),ve(Yt,{position:e,asset:i})]),ve(ho,{team:r})}else await ve(It,{position:e,asset:t,reason:`No wood on field but ${i.sprite.name}`});else await ve(It,{position:e,asset:t,reason:`Not the turn of the team ${t.team}`})}));const Eo=e=>Number.parseInt(e.toString(),10);let Ao,Co;ce.on(Lt,(async e=>{Co&&await ve(Kt),So(e.asset)&&(Ao=e)})),ce.on(Dt,(()=>{Ao=void 0})),ce.on(Wt,(async e=>{var t,o;if(!Ao)return;const i=new ot(Eo(Ao.start.row),Eo(Ao.start.col)).toCube(),r=new ot(Eo(e.row),Eo(e.col)).toCube(),n=e=>{const{row:t,col:o}=e.toCoords();return yo.map[t][o].elements.filter((e=>e.team!==(null==Ao?void 0:Ao.asset.name))).some((e=>ht(e)))},s=((e,t,o,i,r)=>{const n=new St;n.push(e,0);const s={},a={},l=[];let c=!1;if(s[Mt(e)]=Mt(e),a[Mt(e)]=0,e.equals(t))return{path:[]};if(i(t))return{path:[]};for(;n.length>0;){const e=n.pop();if(e.equals(t)){c=!0;break}if(n.length>1e3)throw new Error("No what kinda path are you searching for?!");l.push(e.toPosition().toString());for(const c of e.neighbors(o).filter((e=>!s[Mt(e)])).map((e=>{var t;return null!==(t=o.find((t=>t.equals(e))))&&void 0!==t?t:e}))){if(i(c))continue;l.some((e=>e===Mt(c)))||l.push(Mt(c));const o=a[Mt(e)]+c.cost();r<o||(!a[Mt(c)]||o<a[Mt(c)])&&(a[Mt(c)]=o,n.push(c,o+t.heuristic(c)),s[Mt(c)]=e.toPosition().toString())}}const d=e.toPosition();if(!c)return{path:[],visited:l};let u=t.toPosition();const h=[];do{h.push(u),u=ot.fromString(s[u.toString()])}while(null!==u&&!u.equals(d));return{path:h.reverse(),visited:l}})(i,r,$o,n,Ao.asset.movement.points).path;let a=e;n(r)&&(a=null!==(o=null===(t=[...s].pop())||void 0===t?void 0:t.toCoords())&&void 0!==o?o:Ao.start),await ve(Lt,Object.assign(Object.assign({},Ao),{trail:s,end:a}))})),ce.on(Zt,(async e=>{var t,o;if(!Ao)return;if((null!==(o=null===(t=Ao.trail)||void 0===t?void 0:t.length)&&void 0!==o?o:0)<1)return;const{start:i,asset:r}=Ao;if(!So(r))return;if(void 0===r.actions&&console.error("asset.actions undefined",r),!_o(r))return;if(tt(Ao.start,e))return void ve(Dt);r.actions.current-=1;const n=[...yo.map[i.row][i.col].elements];yo.map[i.row][i.col].elements=[],n.forEach((t=>{t.id!==r.id?yo.map[i.row][i.col].elements.push(Object.assign(Object.assign({},t),{row:i.row,col:i.col})):yo.map[e.row][e.col].elements.push(Object.assign(Object.assign({},t),{row:e.row,col:e.col}))})),await ve(Pt,{row:i.row,col:i.col,elements:[...yo.map[i.row][i.col].elements]}),await ve(Pt,{row:e.row,col:e.col,elements:[...yo.map[e.row][e.col].elements]}),await ve(Dt),await ve(Tt,{asset:r,location:e}),await ve(Nt)})),ce.on(Xt,(async e=>{So(e.asset)&&(Ao&&await ve(Dt),Co=Object.assign(Object.assign({},e),{range:new ot(e.start.row,e.start.col).toCube().range(1).map((e=>e.toPosition().toCoords()))}),ve(Gt,Co))})),ce.on(Ft,(async e=>{if(!Co||!So(Co.asset))return;if(tt(Co.start,e))return void ve(Kt);const{row:t,col:o}=e,{asset:i}=Co,r=[...yo.map[t][o].elements].filter((e=>ht(e)&&e.team!==i.team));_o(i)&&r.length>0&&(i.actions.current-=1,await ve(Jt,{location:e,attacker:[i],defender:[...r]})),ve(Ut,po(yo,i.team)),ve(Kt),await ve(Nt)})),ce.on(Kt,(()=>Co=void 0)),ce.on(Tt,(async({asset:e,location:t})=>{if(!So(e))return;const{row:o,col:i}=t,r=[...yo.map[o][i].elements].filter((t=>t.id!==e.id)).filter((t=>t.name===ti&&t.team!==e.team));if(r.length>0&&ht(e)){const o={asset:r[0],transfered:{from:r[0].team,to:e.team},location:t,by:e,team:e.team};await ve(eo,o)}else ve(Ut,po(yo,e.team)),await ve(Nt)})),ce.on(eo,(({location:e,team:t,asset:o})=>{if(!So({team:t}))return;const{row:i,col:r}=e,n=[...yo.map[i][r].elements];yo.map[i][r].elements=[],n.forEach((e=>{e.id!==o.id?yo.map[i][r].elements.push(e):yo.map[i][r].elements.push(Object.assign(Object.assign({},e),{team:t}))})),ve(Ut,po(yo,t)),ve(ho,{team:t})})),ce.on(Jt,(e=>{ve(to,e)})),ce.on(Vt,(e=>{if(!So(e.attacker.asset))return;const t=go(e.attacker.dices);ve(Qt,{attacker:e.attacker.asset,defender:e.defender,damage:t,location:e.location})})),ce.on(Qt,(e=>{const{defender:t,damage:o,attacker:i}=e;o<0?i.health.current+=o:t.health.current-=o;const{row:r,col:n}=e.location,s=[...yo.map[r][n].elements];yo.map[r][n].elements=[],s.forEach((e=>{e.id===t.id?t.health.current>0&&yo.map[r][n].elements.push(t):e.id===i.id?i.health.current>0&&yo.map[r][n].elements.push(i):yo.map[r][n].elements.push(e)})),ve(Pt,{row:r,col:n,elements:[...yo.map[r][n].elements]}),ve(to,void 0),ve(oo,{attacker:[i],defender:[t],location:e.location,result:o})})),window.location.hash.indexOf("log")>=0&&oe(ee.INFO),window.location.hash.indexOf("trace")>=0&&oe(ee.TRACE);const zo=s`
    :host {
        position: absolute;
        width: 120px;
        height: 140px;
...
`,Bo=(e,t)=>{e.dispatchEvent(new CustomEvent(t))};$e("modal-window",(e=>e.open?T`
    <div id="background" @click="${()=>e.preventClose&&Bo(e,"close")}"></div>
    <div id="modal">
        <header>
            ${e.preventClose?T``:T`<button-pure id="close" @click="${()=>Bo(e,"close")}"><text-block size="large">X</text-block></button-pure>`}
    ...
    `:T``),{styles:[Uo,No],defaults:{open:!1,preventClose:!1}}),$e("modal-container",(e=>{const{getState:t,publish:o}=Ke(e,!1);return T`
...
`,props:[{result:{type:Number}}]});const Po="player-knight";var Lo=$e(Po,(e=>{const{getState:t,publish:o}=Ke(e,"");return me(e,ro,o),T`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/knight_${e.team}.png'"></div>`}),{styles:[zo,To,s`
        div {
            background-size: contain;
            opacity: 1;
        }
        `],defaults:{team:""}}),Do=Object.freeze({__proto__:null,name:Po,default:Lo});const Wo="player-wagon";var Zo=$e(Wo,(e=>{const{getState:t,publish:o}=Ke(e,"");return me(e,ro,o),T`<div class="${t()===e.team?"active":"inactive"}" style="background-image:url('/assets/wagon_${e.team}.png'"></div>`}),{styles:[zo,To,s`
        div {
            background-size: contain;
            opacity: 1;
        }
        `],defaults:{team:""}}),qo=Object.freeze({__proto__:null,name:Wo,default:Zo});$e("dice-selector",(e=>{var t;return T`${null===(t=e.dices)||void 0===t?void 0:t.map((t=>T`<div>
        <input type="radio" 
...
class Io extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){if(super(e),this.it=H,e.type!==Yo)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===H||null==e)return this.ft=void 0,this.it=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Io.directiveName="unsafeHTML",Io.resultType=1;const Xo=(e=>(...t)=>({_$litDirective$:e,values:t}))(Io);async function Go(e){for(const t of e)await t()}const Fo=(e,t)=>{var o,i;return[...null!==(o=t.none)&&void 0!==o?o:[],...null!==(i=t[e])&&void 0!==i?i:[]]};$e("sprite-set",(e=>{const{getState:t,publish:o}=Ke(e,void 0),{getState:i,publish:r}=Ke(e,void 0);return me(e,Pt,(t=>e.row.toString()===(null==t?void 0:t.row.toString())&&e.col.toString()===(null==t?void 0:t.col.toString())),o),me(e,ro,r),t()&&Go(Fo(i(),e.triggers)).then((()=>ve(zt,{item:"hexagon",row:e.row,col:e.col}))),Fe(e,(()=>{e.addEventListener("click",(async()=>{Go(Fo(i(),e.triggers))}))})),T`<slot></slot>`}),{defaults:{row:0,col:0,triggers:{}}}),$e("sprite-player-elements-grid",(()=>T`<slot></slot>`),{styles:s`
    ...
    `});const Ko=(o,i,r)=>{const n={},s=null==o?void 0:o.map((o=>{var s,a,l,c;const d=Object.entries(Object.assign(Object.assign({},t),e)).find((([e,t])=>t.name===o.name)),u=Object.entries(Object.assign(Object.assign({},o),{name:void 0})).filter((([e,t])=>void 0!==t)).map((([e,t])=>`${e}="${t}"`)).join(" "),h=null!==(s=o.team)&&void 0!==s?s:"none";return n[h]=null!==(a=n[h])&&void 0!==a?a:[],n[h].push((()=>{var e;return ve(zt,{item:null!==(e=null==d?void 0:d[1].name)&&void 0!==e?e:"",row:i,col:r,payload:Object.assign({},o)})})),T`${Xo(`<${null!==(l=null==d?void 0:d[1].name)&&void 0!==l?l:"span"} ${u}></${null!==(c=null==d?void 0:d[1].name)&&void 0!==c?c:"span"}>`)}`}));return T`<sprite-set .triggers=${n} col="${r}" row="${i}">${s}</sprite-set>`};$e("fighter-info",(({player:e,row:t,col:o})=>T`<div class="sprite ${(null==e?void 0:e.health.current)<1?"dead":"alive"}">
        ...
        `],props:[{player:{type:Object},row:{type:Number},col:{type:Number}}]});const Jo=s`
:host {
...
`,Qo=(e,t,o)=>`${function(e,t){var o,i;return t?tt(t.start,e)?"active start":t.end&&(null!==(i=null===(o=t.trail)||void 0===o?void 0:o.length)&&void 0!==i?i:0)<1&&tt(t.end,e)?"active unreachable":t.end&&tt(t.end,e)?"active end":t.trail&&t.trail.some((t=>tt(t,e)))?"active trail":"inactive":""}(e,t)} ${function(e,t){return t?tt(t.start,e)?"active start":t.end&&tt(t.end,e)?"active end":t.range&&t.range.some((t=>tt(t,e)))?"active trail":"inactive":""}(e,o)}`,ei=(e,t,o)=>{t&&t.end&&tt(t.end,e)?function(e,t){t&&ve(Zt,e)}(e,t):o&&function(e,t){t&&ve(Ft,e)}(e,o)};$e("hexagon-element",(e=>{var t,o,i;Fe(e,(()=>{e.addEventListener("click",(()=>ve(zt,{item:"hexagon",row:e.row,col:e.col})))}));const{row:r,col:n}=e,{get:s,set:a}=Ke(e,{elements:e.elements,row:r,col:n}),{get:l,set:c}=Ke(e,void 0),{get:d,set:u}=Ke(e,void 0);me(e,Pt,(e=>(null==e?void 0:e.row.toString())===r.toString()&&(null==e?void 0:e.col.toString())===n.toString()),a),me(e,Lt,c),me(e,Gt,u),me(e,Zt,(()=>c(void 0))),me(e,Dt,(()=>c(void 0))),me(e,Kt,(()=>u(void 0)));const h=s();return T`<div 
      class="hexagon ${Qo(e,l(),d())}" 
      @mouseover=${()=>{l()&&ve(Wt,{row:r,col:n})}}
      @click=${()=>(ei(e,l(),d()),document.dispatchEvent(new CustomEvent("hello-world",{detail:{hello:"world"}})))}
      ...
      ${Ko(h.elements,e.row,e.col)}</div>`}),{styles:[Jo,Vo],defaults:{background:void 0,elements:[],col:0,row:0}}),$e("world-map",(e=>{var t;const{get:o,set:i}=Ke(e,void 0);return me(e,$t,i),T`<div id="globe">${null===(t=o())||void 0===t?void 0:t.map.map(((e,t)=>T`<div class="row ${t%2==0?"push":""}" style="width: calc(${120*e.length}px + 20rem)">
...
`,$i=(e,t)=>T`
  ...
  `;$e("sidebar-castle",(e=>{var t;const{selected:{payload:{team:o},row:i,col:r}}=e,{getState:n,publish:s}=Ke(e,void 0);me(e,At,s);const{resources:a}=null!==(t=n())&&void 0!==t?t:{resources:{}};return T`<building-castle-small team="${o}"></building-castle-small>
      <h3>${bi(fi.castle.build)}</h3>
      <div class="container">
        <button-image
          height="35px"
          src="/assets/knight_${o}.png"
          title="${bi(fi.properties.actions.build.knight)}"
        ...
        <button-image
          ...
          title="${bi(fi.properties.actions.build.wagon)}"
          @click=${async()=>await ve(Ht,{team:o,row:i,col:r})}
        >
          ${$i(a,ui())}
        </button-image>
        <button-image height="35px" 
          title="${bi(fi.properties.actions.build.iron)}"
          src="/assets/resources/iron.png">
          ${$i(a,vi())}
        </button-image>
        <button-image height="35px" 
          title="${bi(fi.properties.actions.build.castle_medium)}"
          src="/assets/castle_medium_${o}.png">
          ${$i(a,gi())}
        </button-image>
        <button-image height="35px" 
          title="${bi(fi.properties.actions.build.castle_large)}"
          src="/assets/castle_large_${o}.png">
          ${$i(a,mi())}
        </button-image>
      </div>`}),{styles:[wi,yi],defaults:{selected:{payload:{team:""},col:0,row:0}}});const ki=e=>parseInt(e.toString(),10);$e("sidebar-knight",(e=>{const{selected:{payload:t,row:o,col:i}}=e,{health:r,actions:n}=t,s={row:ki(o),col:ki(i)};return T`
    <h3>${bi(fi.knight)}</h3>
    <div class="container">
        <img id="knight" src="/assets/knight_${t.team}.png">
        <loading-bar id="health" width="${r.current/r.max*100}%"></loading-bar>
        <div id="stats">
            ${Xo(bi(fi.properties.life,r.current,r.max))}<br>
            ${Xo(bi(fi.properties.actions,n.current,n.max))}
        </div>
        <button ?disabled=${n.current<1} id="move" title="${bi(fi.properties.actions.move)}" @click=${()=>ve(Lt,{asset:Object.assign({},t),start:s})}>🦵</button>
        <button ?disabled=${n.current<1} id="attack" title="${bi(fi.properties.actions.attack)}" @click=${()=>ve(Xt,{asset:Object.assign({},t),start:s})}">⚔</button>
        <button ?disabled=${n.current<1} id="fortify" title="${bi(fi.properties.actions.fortify)}" >🏰</button>
    </div>`}),{styles:[wi,s`
    .container {
        grid-template-areas: 
...
`],props:[{selected:{type:Object}}]});const xi=s`
    :host {
        display: block;
        background-image: url('/assets/sidebar/bg.png');
        background-size: 100% 100%;
...
`;ce.on(Yt,((...e)=>console.log("BuildLumberjackSmallSuccess",...e))),ce.on(It,console.error),ce.on(qt,((...e)=>console.log("BuildLumberjackSmall",...e))),$e("sidebar-wagon",(e=>{const{selected:{payload:t,row:o,col:i}}=e,{health:r,actions:n}=t,s={row:ki(o),col:ki(i)};return T`
    <h3>${bi(fi.wagon)}</h3>
    <div class="container">
        ...
        <button ?disabled=${n.current<1} id="move"  title="${bi(fi.properties.actions.move)}" @click=${()=>ve(Lt,{asset:Object.assign({},t),start:s})}>🦵</button>
        <button ?disabled=${n.current<1} id="build_lumberjack" title="${bi(fi.properties.actions.build.lumberjack_small)}" @click=${()=>ve(qt,{asset:Object.assign({},t),position:s})}>
            <img id="build_lumberjack_small" src="/assets/lumberjack_small_${t.team}.png">
        </button>
        <button ?disabled=${n.current<1} id="load"  title="${bi(fi.properties.actions.load)}">📦</button>
    </div>`}),{styles:[xi],props:[{selected:{type:Object}}]});const ji=e=>({position:e?new ot(null==e?void 0:e.row,null==e?void 0:e.col):void 0,elements:e?[{item:e.item,payload:e.payload}]:[],dirty:!1});$e("controls-sidebar",(async e=>{const{get:t,set:o}=Ke(e,void 0);me(e,zt,o);const i=t(),{get:r,set:n}=Ke(e,ji(i)),s=r();return console.log("controls-sidebar",s,i),!s.dirty&&i&&new ot(i.row,i.col).equals(s.position)?n(Object.assign(Object.assign({},s),{elements:[...s.elements,{item:i.item,payload:i.payload}],dirty:"hexagon"===i.item})):n(ji(i)),Fe(e,(()=>{setTimeout((()=>{ve(xt)}),1)})),T`
        ${r().elements.map((e=>{var t,o,i,n,s,a;switch(e.item){case ri:return T`<sidebar-castle 
                        .selected="${{row:null===(t=r().position)||void 0===t?void 0:t.row,col:null===(o=r().position)||void 0===o?void 0:o.col,payload:e.payload}}">
                    </sidebar-castle>`;case Po:return T`<sidebar-knight
                        .selected="${{row:null===(i=r().position)||void 0===i?void 0:i.row,col:null===(n=r().position)||void 0===n?void 0:n.col,payload:e.payload}}">
                    </sidebar-knight>`;case Wo:return T`<sidebar-wagon
                        .selected="${{row:null===(s=r().position)||void 0===s?void 0:s.row,col:null===(a=r().position)||void 0===a?void 0:a.col,payload:e.payload}}">
                    </sidebar-wagon>`;default:case ri:return T``}}))}
    `}),{styles:s`:host { 
        position: absolute;
        display: block;
        min-width: 200px;
        ...
        top: 20px;
        z-index: 2;
    }`}),$e("modal-battle",(e=>{var t,o;const{getState:i,publish:r}=Ke(e,void 0),{getState:n,publish:s}=Ke(e,void 0);return me(e,to,r),T`
   <modal-window 
        .open=${!!i()} 
        preventClose>
        ...
        `]}),$e("modal-dice-result",(e=>{var t,o;const{getState:i,publish:r}=Ke(e,void 0);return me(e,oo,r),T`
   <modal-window 
        .open=${!!i()} 
        @close=${()=>r(void 0)}>
        ...
        `]}),$e("modal-mill-taken",(e=>{var t,o,i,r,n;const{getState:s,publish:a}=Ke(e,void 0);return me(e,eo,a),T`
    <modal-window 
         .open=${!!s()} 
         @close=${()=>a(void 0)}>
    ...
    `}),$e("modal-no-more-turns",(e=>{const{getState:t,publish:o}=Ke(e,void 0);return me(e,Bt,o),T`
   <modal-window 
        .open=${!!t()} 
        preventClose>
    ...
    <modal-mill-taken></modal-mill-taken>`)),$e("footer-element",(o=>{const{get:i,set:r}=Ke(o,void 0),{get:n,set:s}=Ke(o,[]);return me(o,ro,r),me(o,Ut,s),T`<footer class="${i()}">
    <div class="main ">
        ${((o,i="")=>{const r=null==o?void 0:o.map((o=>{var r,n;const s=Object.entries(Object.assign(Object.assign({},t),e)).find((([e,t])=>t.name===o.name)),a=Object.entries(Object.assign(Object.assign({},o),{name:void 0})).filter((([e,t])=>void 0!==t)).map((([e,t])=>`${e}="${t}"`)).join(" "),l=dt(o)?{row:o.row,col:o.col}:{row:0,col:0};return T`<div
            @click="${()=>{ve(Ct,Object.assign(Object.assign({item:o.name},l),{payload:o})),setTimeout((()=>{var e;null===(e=fo(o))||void 0===e||e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}),2)}}"
            @mouseover="${()=>{setTimeout((()=>{var e;null===(e=fo(o))||void 0===e||e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}),2)}}"
...
</footer>`}),{styles:[Ro,Ho(s`footer .main`),s`
    footer {
        min-height: 10vh;
        max-height: 10vh;
        display: grid;
...
`;var _i;$e("resource-grain",(()=>T`<div title="${bi(pi.grain)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/grain.png");
        }
      `,Oi]}),$e("resource-stone",(()=>T`<div title="${bi(pi.stone)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/stone.png");
        }
      `,Oi]}),$e("resource-iron",(()=>T`<div title="${bi(pi.iron)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/iron.png");
        }
      `,Oi]}),$e("resource-wood",(()=>T`<div title="${bi(pi.log)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/log.png");
        }
      `,Oi]}),$e("resource-hay",(()=>T`<div title="${bi(pi.hay)}"></div>`),{styles:[s`
        :host {
          background-image: url("/assets/resources/hay.png");
        }
      `,Oi]}),$e("resource-counter",(({count:e,collect:t})=>T`
        <slot></slot>
        ${e} ${t?T`<span>(+${t})</span>`:""}
    `),{styles:[s`
        :host {
        ...
        `],defaults:{count:0,collect:void 0}}),$e("header-element",(e=>{var t,o,i,r,n,s,a,l;const{get:c,set:d}=Ke(e,void 0),{get:u,set:h}=Ke(e,void 0),{get:v,set:g}=Ke(e,void 0);me(e,ro,d),me(e,At,h),me(e,vo,g);const m=null!==(t=u())&&void 0!==t?t:{resources:{}},p=(e,t,o)=>(e[t]=(e[t]||0)+o,e),f=null!==(i=null===(o=v())||void 0===o?void 0:o.resourcesToGenerate.reduce(((e,t)=>{var o,i;for(const r of lt)e=p(e,r,null!==(i=null===(o=t.resources[r])||void 0===o?void 0:o.generatedResource)&&void 0!==i?i:0);return e}),{}))&&void 0!==i?i:{};return T`<header class="${c()}">
        <resource-counter title="${bi(pi.hay)}" count="${m.resources.hay}" collect=${null!==(r=f.hay)&&void 0!==r?r:0}>
            <resource-hay></resource-hay>
        </resource-counter>
        <resource-counter title="${bi(pi.grain)}" count="${m.resources.grain}" collect=${null!==(n=f.grain)&&void 0!==n?n:0}>
            <resource-grain></resource-grain>
        </resource-counter>
        <resource-counter title="${bi(pi.stone)}" count="${m.resources.stone}" collect=${null!==(s=f.stone)&&void 0!==s?s:0}>
            <resource-stone></resource-stone>
        </resource-counter>
        <resource-counter title="${bi(pi.iron)}" count="${m.resources.iron}" collect=${null!==(a=f.iron)&&void 0!==a?a:0}>
            <resource-iron></resource-iron>
        </resource-counter>
        <resource-counter title="${bi(pi.log)}" count="${m.resources.wood}" collect=${null!==(l=f.wood)&&void 0!==l?l:0}>
            <resource-wood></resource-wood>
        </resource-counter>
    </header>`}),{styles:s`
    header {
    ...
    }`}),null===(_i=document.querySelector("body"))||void 0===_i||_i.addEventListener("keyup",(function(e){"Escape"===e.key&&ve(Et,!0)})),$e("the-mill",(()=>((async({rows:e,cols:t})=>{const o=jt({rows:e,cols:t}),i=Ot("green",{rows:e,cols:t}),r=Ot("red",{rows:e,cols:t}),n=Je(0,e-1).map((e=>Je(0,t-1).map((t=>({position:new ot(e,t),terrain:yt(),elements:[..._t(o,e,t),..._t(i,e,t),..._t(r,e,t)]})))));await ve($t,{map:n,teams:["red","green"]})})({rows:10,cols:10}),T`
    ...
    `)),{styles:[Ro,Ho(s`world-map`),Ho(s`controls-sidebar`),s`
    header-element {
        grid-area: header;
    }
    world-map {
    ...
    `]});const Si=window.location.search.substring(1).split("&").reduce(((e,t)=>{const[o,i]=t.split("=");return e[o]=i,e}),{});document.documentElement.lang=Si.lang||"en";export{t as buildings,Do as knight,e as player,qo as wagon};
